...
* Generated Angular `httpResource` service for CalendareResource
...
export class CalendareResource {
    ...
    getCredentialOfUser(username: Signal<string> | string, credentialSubject: Signal<string> | string, credentialType: Signal<string | undefined> | string | undefined, resourceOptions: HttpResourceOptions<CredentialResponse, unknown> & { defaultValue: NoInfer<CredentialResponse> }, requestOptions?: Omit<HttpResourceRequest, "method" | "url" | "params">): HttpResourceRef<CredentialResponse>;
    ...
    getCredentialOfUser(username: Signal<string> | string, credentialSubject: Signal<string> | string, credentialType?: Signal<string | undefined> | string, resourceOptions?: HttpResourceOptions<CredentialResponse, unknown>, requestOptions?: Omit<HttpResourceRequest, "method" | "url" | "params">): HttpResourceRef<CredentialResponse | undefined> {
        return httpResource(() => {
            ...
            if (credentialTypeValue != null) {
                params = HttpParamsBuilder.addToHttpParams(params, credentialTypeValue, 'credentialType');
            }
            return {
                url: `${this.basePath}/api/credentials/user/${typeof username === 'function' ? username() : username}/${typeof credentialSubject === 'function' ? credentialSubject() : credentialSubject}`,
                method: "GET",
                ...requestOptions,
                params,
                context: this.createContextWithClientId(requestOptions?.context)
