...
const inputGroupAddonVariants = cva(
  "text-muted-foreground h-auto gap-2 py-2.5 text-base font-medium group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>ng-icon:not([class*='text-'])]:text-[length:--spacing(5)] flex cursor-text items-center justify-center select-none",
  {
    variants: {
      align: {
